...
# 3.1 处理分类特征
categorical_features = ['Room Type', 'State']
le = LabelEncoder()
...
facility_features=['Private Bathroom' 'Share Bathroom' 'Air-Conditioning' 'State_encoded'
 'Room Type_encoded']
...
logging.info("To tune these models, please run model_xgboost_tuning.py")
